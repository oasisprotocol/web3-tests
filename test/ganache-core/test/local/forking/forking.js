...
describe("Forking", function() {
    ...
    describe("cache", () => {
            ...
            return async () => {
                ...
                try {
                    ...
                    forkedServer.provider.send = (...args) => {
                        ...
                        if (
                            payload.method === "eth_getStorageAt" &&
                            payload.params[0] === contractAddress.toLowerCase()
                        ) {
                            callCount++;
                        }
        ...
        it(
            "should return from the cache on successive calls to the same data when cache is infinite",
            testCache(-1, 1)
        );
