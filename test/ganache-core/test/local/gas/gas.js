        ...
        describe(`Hardfork: ${hardfork.toUpperCase()}`, function() {
            ...
            describe("EIP150 Gas Estimation: ", function() {
                ...
                before("Setting up EIP150 contracts", async function() {
                    ...
                    TestDepth = await bootstrap(
                        testDepth,
                        Object.assign({ db: memdown() }, ganacheProviderOptions),
                        hardfork
                    );
                ...
                if (hardfork !== "byzantium") {
                    ...
                    it("Should estimate gas perfectly with EIP150 - Simple Value Transfer", async () => {
                        ...
                        const { gasUsed: signedGasUsed } = await web3.eth.sendSignedTransaction(
                    ...
                    async function() {
                        ...
                        switch (provider.options.hardfork) {
                            ...
                            case "istanbul":
                                ...
                                assert(
                                    receipt.gasUsed <=
                                        estimate - RSCLEAR_REFUND_FOR_RESETTING_DIRTY_SLOT_TO_ZERO_ISTANBUL + 2300
                                );
                                break;
                            case "constantinople":
                    ...
                    async function() {
                        ...
                        switch (provider.options.hardfork) {
                            ...
                            case "istanbul": // EIP-2200
                                assert(
                                    receipt.gasUsed <=
                                        gasEstimate - rsclearRefundForResettingDirtySlotToNonZeroValueIstanbul + 2300
                                );
                                break;
                            case "constantinople":
                                ...
                                assert.strictEqual(
                                    receipt.gasUsed,
                                    gasEstimate - rsclearRefundForResettingDirtySlotToNonZeroValue
                                );
                                break;
                            default:
                                throw new Error("Invalid hardfork option: " + provider.options.hardfork);
